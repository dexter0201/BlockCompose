...
class BlockComposeServiceProvider extends BaseServiceProvider
{
    ...
    public function readConfig()
    {
        ...
        $this->disable_custom_colors = config(
            'editor.disable_custom_color_palette'
        );
        ...
        $this->reusable_custom_fields = config(
            'editor.reusable_blocks_enable_custom_fields'
        );
        $this->reusable_cap_type = config(
            'editor.reusable_blocks_capability_type'
        );
        $this->reusable_caps = config('editor.reusable_blocks_capabilities');
        $this->expose_to_graphql = config(
            'editor.reusable_blocks_expose_to_graphql'
        );
    }
    ...
    {
        $deps = ['wp-editor', 'wp-element', 'wp-blocks'];
    ...
    public function setReusableBlockOptions()
    {
        ...
        if ($this->reusable_custom_fields == true) {
            $this->type->supports = ['title', 'editor', 'custom-fields'];
        }
            ...
            function ($args, $post_type) {
                if ('wp_block' === $post_type) {
                    ...
                    $args['graphql_single_name'] =
                        $this->reusable_block_labels['singular_name'];
                    $args['graphql_plural_name'] =
                        $this->reusable_block_labels['name'];
                }
